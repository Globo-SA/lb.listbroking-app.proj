...
class StagingContact
{
    ...
    public static $import_template = array(
        'external_id'                  => '',
        'contact_id'                   => 'mandatory IF is to update contacts',
        'phone'                        => 'MANDATORY',
        'email'                        => '',
        'firstname'                    => 'MANDATORY',
        'lastname'                     => '',
        'birthdate'                    => 'MANDATORY (yyyy-mm-dd)',
        'address'                      => '',
        'postalcode1'                  => '',
        'postalcode2'                  => '',
        'ipaddress'                    => '',
        'gender'                       => 'MANDATORY (M, F)',
        'district'                     => '',
        'county'                       => '',
        'parish'                       => '',
        'country'                      => 'MANDATORY (PT, ES, ...)',
        'source_name'                  => '',
        'source_external_id'           => 'MANDATORY (1, 2, ...)',
        'source_country'               => '',
        'sub_category'                 => 'MANDATORY (general, ...)',
        'date'                         => '',
