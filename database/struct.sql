...
--
-- Table structure for table `tmp_20160804`
--

DROP TABLE IF EXISTS `tmp_20160804`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tmp_20160804` (
  `phone` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `tmp_20160810`
--

DROP TABLE IF EXISTS `tmp_20160810`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tmp_20160810` (
  `phone` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `tmp_20160812`
--

DROP TABLE IF EXISTS `tmp_20160812`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tmp_20160812` (
  `phone` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `tmp_bigpremio_clean_staging_contacts`
--

DROP TABLE IF EXISTS `tmp_bigpremio_clean_staging_contacts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tmp_bigpremio_clean_staging_contacts` (
  ...
  `birthdate` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `address` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `postalcode1` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `postalcode2` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `parish` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `source_external_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `source_country` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `sub_category` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `date` date DEFAULT NULL,
  `initial_lock_expiration_date` date DEFAULT NULL,
  `post_request` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci COMMENT '(DC2Type:json_array)',
  `validations` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci COMMENT '(DC2Type:json_array)',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
...
--
-- Table structure for table `tmp_bigpremio_contacts`
--

DROP TABLE IF EXISTS `tmp_bigpremio_contacts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tmp_bigpremio_contacts` (
  `contact_id` int(11) DEFAULT NULL,
  ...
  `postalcode1` int(11) DEFAULT NULL,
  `postalcode2` varchar(255) DEFAULT NULL,
  ...
  `resting_date` varchar(255) DEFAULT NULL,
  `owner_name` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `tmp_bigpremio_new_owner`
--

DROP TABLE IF EXISTS `tmp_bigpremio_new_owner`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tmp_bigpremio_new_owner` (
  `id` bigint(20) NOT NULL DEFAULT '0',
  `external_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `valid` tinyint(4) NOT NULL DEFAULT '0',
  `processed` tinyint(4) NOT NULL DEFAULT '0',
  `running` tinyint(4) NOT NULL DEFAULT '0',
  `for_update` tinyint(4) DEFAULT NULL,
  `phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `is_mobile` tinyint(4) NOT NULL DEFAULT '0',
  `in_opposition` tinyint(4) NOT NULL DEFAULT '0',
  `lead_id` bigint(20) DEFAULT NULL,
  `contact_id` bigint(20) DEFAULT NULL,
  `email` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `firstname` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `date` date DEFAULT NULL,
  `initial_lock_expiration_date` date DEFAULT NULL,
  `post_request` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `validations` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  KEY `lead_id` (`lead_id`),
  KEY `contact_id` (`contact_id`)
...
--
-- Table structure for table `tmp_bigpremio_staging`
--

DROP TABLE IF EXISTS `tmp_bigpremio_staging`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tmp_bigpremio_staging` (
  `id` bigint(20) NOT NULL DEFAULT '0',
  `external_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `valid` tinyint(4) NOT NULL DEFAULT '0',
  ...
  `in_opposition` tinyint(4) DEFAULT NULL,
  `lead_id` bigint(20) DEFAULT NULL,
  `contact_id` bigint(20) DEFAULT NULL,
  `email` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `firstname` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `sub_category` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `date` date DEFAULT NULL,
  `initial_lock_expiration_date` date NOT NULL DEFAULT '0000-00-00',
  `post_request` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `validations` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
...
--
-- Table structure for table `tmp_extraction_931_contacts_not_extracted`
--

DROP TABLE IF EXISTS `tmp_extraction_931_contacts_not_extracted`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tmp_extraction_931_contacts_not_extracted` (
  `phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `tmp_extraction_deduplication_928_phone`
--

DROP TABLE IF EXISTS `tmp_extraction_deduplication_928_phone`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tmp_extraction_deduplication_928_phone` (
  `phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `tmp_extraction_deduplication_931_phone`
--

DROP TABLE IF EXISTS `tmp_extraction_deduplication_931_phone`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tmp_extraction_deduplication_931_phone` (
  `phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `tmp_extraction_deduplication_940_phone`
--

DROP TABLE IF EXISTS `tmp_extraction_deduplication_940_phone`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tmp_extraction_deduplication_940_phone` (
  `phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `tmp_match_20170704`
--

DROP TABLE IF EXISTS `tmp_match_20170704`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tmp_match_20170704` (
  `id` bigint(25) NOT NULL AUTO_INCREMENT,
  `email` varchar(100) NOT NULL,
  `phone` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=327677 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `tmp_staging_contact_bigpremio`
--

DROP TABLE IF EXISTS `tmp_staging_contact_bigpremio`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tmp_staging_contact_bigpremio` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `external_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `valid` tinyint(1) NOT NULL DEFAULT '0',
  ...
  `in_opposition` tinyint(1) DEFAULT NULL,
  `lead_id` bigint(20) DEFAULT NULL,
  `contact_id` bigint(20) DEFAULT NULL,
  `email` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `firstname` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `sub_category` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `date` date NOT NULL,
  `initial_lock_expiration_date` date NOT NULL,
  `post_request` longtext COLLATE utf8_unicode_ci COMMENT '(DC2Type:json_array)',
  `validations` longtext COLLATE utf8_unicode_ci COMMENT '(DC2Type:json_array)',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  ...
  KEY `email_index` (`email`),
  KEY `phone_index` (`phone`)
) ENGINE=InnoDB AUTO_INCREMENT=95968 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `tmp_staging_contact_clean_092016`
--

DROP TABLE IF EXISTS `tmp_staging_contact_clean_092016`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tmp_staging_contact_clean_092016` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `external_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `valid` tinyint(1) NOT NULL DEFAULT '0',
  `processed` tinyint(1) DEFAULT '0',
  ...
  KEY `email_index` (`email`),
  KEY `phone_index` (`phone`)
) ENGINE=InnoDB AUTO_INCREMENT=155998 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `tmp_zizabi_20160607`
--

DROP TABLE IF EXISTS `tmp_zizabi_20160607`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tmp_zizabi_20160607` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `external_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `valid` tinyint(1) NOT NULL DEFAULT '0',
  `processed` tinyint(1) DEFAULT '0',
