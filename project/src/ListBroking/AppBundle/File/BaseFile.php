...
/**
 * ListBroking\AppBundle\File\BaseFile
 */
class BaseFile
{
     ...
     * @return string
     */
    protected function generateFilename($name, $extension, $absolute = false, $dir = '/')
    {
        $path = sprintf('%s%s', $dir, $this->cleanUpName($name, strtolower($extension)));

        if ($absolute) {
            $path = sprintf('%s%s',  $this->projectRootDir, $path);
        }
     ...
     * @return string
     */
    protected function cleanUpName($name, $extension = null)
    {
